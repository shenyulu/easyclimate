...
def test_calc_yearly_climatological_mean():
   ...
   refer_data = np.array([28.05561 , 27.54706 , 26.360346, 26.331762, 27.150057, 28.361261,
      ...
      26.144049, 26.782167, 27.768991, 27.336067, 27.41667 , 27.152414,
      27.20459 , 26.508265, 26.299393, 27.408394, 26.581076, 26.203554,
      27.019026, 26.81861 , 27.279343, 28.620821, 27.416452, 26.947464,
...
def test_calc_yearly_climatological_sum():
   ...
   refer_data = np.array([336.66733, 330.56473, 316.32416, 315.98114, 325.8007 , 340.33514,
      ...
      313.72858, 321.38602, 333.2279 , 328.0328 , 329.00003, 325.82898,
      326.45508, 318.09918, 315.5927 , 328.90073, 318.9729 , 314.44266,
      324.2283 , 321.8233 , 327.3521 , 343.44986, 328.99744, 323.36957,
...
def test_calc_yearly_climatological_std():
   ...
   refer_data = np.array([0.781642  , 1.447736  , 0.71981126, 0.4682538 , 0.6436484 ,
      ...
      1.1294414 , 1.6210439 , 0.6984898 , 0.73770326, 0.60698843,
      0.54717666, 0.33623984, 0.37495157, 0.6960779 , 0.69846976,
      0.98992085, 0.8155603 , 0.84391856, 1.3736537 , 0.7953866 ,
      0.7212148 , 0.48427   , 0.654426  , 0.7627099 , 1.2827027 ,
      0.8893827 , 0.67814404, 0.626694  , 0.9927236 , 0.7345214 ,
      0.4557853 ])
   assert np.isclose(result_data, refer_data).all()
...
def test_calc_yearly_climatological_var():
   ...
   refer_data = np.array([0.61096424, 2.0959396 , 0.5181282 , 0.21926162, 0.41428322,
      ...
      1.2756379 , 2.6277835 , 0.48788795, 0.5442061 , 0.36843494,
      0.29940233, 0.11305723, 0.14058869, 0.4845244 , 0.48786   ,
      0.9799433 , 0.66513854, 0.71219856, 1.8869243 , 0.6326399 ,
      0.5201508 , 0.23451744, 0.42827338, 0.5817264 , 1.6453263 ,
      0.79100156, 0.4598793 , 0.3927454 , 0.98550004, 0.53952163,
      0.20774025])
   assert np.isclose(result_data, refer_data).all()
...
def test_calc_yearly_climatological_max():
   ...
   refer_data = np.array([29.209   , 29.35432 , 27.386578, 27.1092  , 27.72616 , 29.02186 ,
      ...
      27.11696 , 27.67564 , 28.42584 , 27.80502 , 28.050442, 28.1996  ,
      27.905638, 27.774899, 27.185339, 28.2901  , 28.358177, 27.45816 ,
      27.95456 , 27.67382 , 28.30268 , 29.593298, 29.163437, 28.298698,
...
def test_calc_yearly_climatological_min():
   ...
   refer_data = np.array([26.69558 , 25.57518 , 24.9959  , 25.427319, 25.7817  , 27.59936 ,
      ...
      24.64976 , 25.73842 , 26.49118 , 26.84684 , 26.73786 , 25.88236 ,
      25.63848 , 24.96648 , 24.704678, 25.538061, 24.943438, 24.92612 ,
      25.4802  , 26.151379, 26.05032 , 27.102139, 25.9505  , 25.785618,
      25.81622 , 26.694141, 25.297081, 25.570898, 25.633379])
   assert np.isclose(result_data, refer_data).all()