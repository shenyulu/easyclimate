...
data_u = xr.open_dataset(os.path.join(TEST_DATA_PATH, 'test_input_interp_mesh2mesh.nc')).uwnd
data_output = xr.open_dataset(os.path.join(TEST_DATA_PATH, 'test_output_interp_mesh2mesh.nc'))
