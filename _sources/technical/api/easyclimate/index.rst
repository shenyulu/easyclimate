...
.. autoapisummary::
   ...
   easyclimate.calc_dx_gradient
   easyclimate.calc_dlon_radian_gradient
   easyclimate.calc_dlon_degree_gradient
   easyclimate.calc_dy_gradient
   easyclimate.calc_dlat_radian_gradient
   easyclimate.calc_dlat_degree_gradient
   easyclimate.calc_dx_laplacian
   easyclimate.calc_dy_laplacian
   easyclimate.calc_dxdy_mixed_derivatives
   ...
   easyclimate.calc_dxdy_laplacian
   ...
   easyclimate.calc_shear_stretch_deform
   ...
   easyclimate.calc_yearly_mean
   easyclimate.calc_yearly_sum
   easyclimate.calc_yearly_std
   easyclimate.calc_yearly_var
   easyclimate.calc_yearly_max
   easyclimate.calc_yearly_min
   easyclimate.calc_monthly_mean
   easyclimate.calc_monthly_sum
   easyclimate.calc_monthly_std
   easyclimate.calc_monthly_var
   easyclimate.calc_monthly_max
   easyclimate.calc_monthly_min
   easyclimate.open_tutorial_dataset
   easyclimate.open_datanode
   easyclimate.transfer_units_coeff
   easyclimate.transfer_data_multiple_units
   easyclimate.transfer_data_difference_units
   easyclimate.transfer_data_temperature_units
...
.. py:function:: calc_divergence(u_data: xarray.DataArray, v_data: xarray.DataArray, lon_dim: str = 'lon', lat_dim: str = 'lat', R: float = 6371200.0, spherical_coord=True, cyclic_boundary=False, method: Literal['easyclimate', 'uv2dv_cfd-ncl'] = 'uv2dv_cfd-ncl') -> xarray.DataArray
...
.. py:function:: calc_vorticity(u_data: xarray.DataArray, v_data: xarray.DataArray, lon_dim: str = 'lon', lat_dim: str = 'lat', R: float = 6371200.0, spherical_coord: bool = True, cyclic_boundary=False, method: Literal['easyclimate', 'uv2vr_cfd-ncl'] = 'uv2vr_cfd-ncl') -> xarray.DataArray
...
.. py:function:: calc_geostrophic_wind_vorticity(z_data: xarray.DataArray, lon_dim: str = 'lon', lat_dim: str = 'lat', spherical_coord: bool = True, omega: float = 7.292e-05, g: float = 9.8, R: float = 6371200.0, cyclic_boundary=False, method: Literal['easyclimate', 'uv2vr_cfd-ncl'] = 'uv2vr_cfd-ncl') -> xarray.DataArray
...
.. py:function:: calc_eady_growth_rate(u_daily_data: xarray.DataArray, z_daily_data: xarray.DataArray, temper_daily_data: xarray.DataArray, vertical_dim: str, vertical_dim_units: Literal['hPa', 'Pa', 'mbar'], lat_dim='lat') -> xarray.Dataset
