...
.. py:function:: normalize_zscore(da: xarray.DataArray, dim: str = 'time', ddof: int = 1) -> xarray.DataArray
...
.. py:function:: normalize_minmax(da: xarray.DataArray, dim: str = 'time', feature_range: tuple[float, float] = (0, 1)) -> xarray.DataArray
...
.. py:function:: normalize_robust(da: xarray.DataArray, dim: str = 'time', q_low: float = 0.25, q_high: float = 0.75) -> xarray.DataArray
...
.. py:function:: normalize_mean(da: xarray.DataArray, dim: str = 'time') -> xarray.DataArray
