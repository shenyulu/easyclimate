...
.. toctree::
   ...
   /technical/api/easyclimate/core/diagnosis/index
   ...
   /technical/api/easyclimate/core/yearstat/index
...
.. autoapisummary::
   ...
   easyclimate.core.calc_brunt_vaisala_frequency_atm
   easyclimate.core.get_coriolis_parameter
   easyclimate.core.calc_potential_temperature
   easyclimate.core.calc_potential_temperature_vertical
   easyclimate.core.calc_equivalent_potential_temperature
   easyclimate.core.calc_equivalent_potential_temperature_davies_jones2009
   easyclimate.core.calc_virtual_temperature_Hobbs2006
   easyclimate.core.calc_virtual_temperature
   easyclimate.core.calc_static_stability
   easyclimate.core.calc_dewpoint
   easyclimate.core.calc_mixing_ratio
   easyclimate.core.calc_vapor_pressure
   easyclimate.core.calc_saturation_vapor_pressure
   easyclimate.core.calc_saturation_mixing_ratio
   easyclimate.core.calc_wet_bulb_potential_temperature_iteration
   easyclimate.core.calc_wet_bulb_potential_temperature_davies_jones2008
   easyclimate.core.calc_wet_bulb_temperature_stull2011
   easyclimate.core.calc_wet_bulb_temperature_sadeghi2013
   easyclimate.core.calc_lifting_condensation_level_bolton1980
   easyclimate.core.calc_lifting_condensation_level_Bohren_Albrecht2023
   easyclimate.core.calc_moist_adiabatic_lapse_rate
   easyclimate.core.transfer_mixing_ratio_2_specific_humidity
   easyclimate.core.transfer_specific_humidity_2_mixing_ratio
   easyclimate.core.transfer_dewpoint_2_specific_humidity
   easyclimate.core.transfer_dewpoint_2_mixing_ratio
   easyclimate.core.transfer_specific_humidity_2_dewpoint
   easyclimate.core.transfer_dewpoint_2_relative_humidity
   easyclimate.core.transfer_mixing_ratio_2_relative_humidity
   easyclimate.core.transfer_specific_humidity_2_relative_humidity
   easyclimate.core.calc_gradient
   easyclimate.core.calc_lon_gradient
   easyclimate.core.calc_lat_gradient
   easyclimate.core.calc_lon_laplacian
   easyclimate.core.calc_lat_laplacian
   easyclimate.core.calc_lon_lat_mixed_derivatives
   ...
   easyclimate.core.calc_laplacian
   ...
   easyclimate.core.calc_yearly_climatological_mean
   easyclimate.core.calc_yearly_climatological_sum
   easyclimate.core.calc_yearly_climatological_std
   easyclimate.core.calc_yearly_climatological_var
   easyclimate.core.calc_yearly_climatological_max
   easyclimate.core.calc_yearly_climatological_min
...
.. py:function:: calc_potential_temperature_vertical(temper_data: xarray.DataArray, vertical_dim: str, vertical_dim_units: str, kappa: float = 287 / 1005.7) -> xarray.DataArray
...
.. py:function:: calc_corr_spatial(data_input: xarray.DataArray, x: xarray.DataArray | numpy.ndarray, time_dim: str = 'time') -> xarray.Dataset
