...
.. py:function:: get_EOF_model(data_input: xarray.DataArray | list, lat_dim: str, lon_dim: str, time_dim: str = 'time', n_modes: int = 10, remove_seasonal_cycle_mean=False, center: bool = False, standardize: bool = False, use_coslat: bool = True, random_state=None, solver='auto', solver_kwargs={}) -> xeofs.single.eof.EOF
