...
.. autoapisummary::
   ...
   easyclimate.field.monsoon.index_npwi.calc_NPWI_monsoon_detreat
...
.. py:function:: calc_NPWI_monsoon_detreat(NPWI: xarray.DataArray, monsoon_onset_date: xarray.DataArray, thresh: float = 0.618, consecutive_days: int = 3, n: int = 7, lon_dim: str = 'lon', lat_dim: str = 'lat', time_dim: str = 'time') -> xarray.DataArray
