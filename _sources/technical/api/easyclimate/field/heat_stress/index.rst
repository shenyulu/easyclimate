...
.. py:function:: calc_apparent_temperature(temperature_data: xarray.DataArray, vapor_pressure_data: xarray.DataArray, wind_10m_data: xarray.DataArray, temperature_data_units: Literal['degC', 'degF', 'degK'], vapor_pressure_data_units: Literal['Pa', 'hPa', 'mb'], wind_10m_data_units: Literal['m/s'] = 'm/s') -> xarray.DataArray
...
.. py:function:: calc_simplified_human_discomfort_index(temperature_data: xarray.DataArray, vapor_pressure_data: xarray.DataArray, temperature_data_units: Literal['degC', 'degF', 'degK'], vapor_pressure_data_units: Literal['Pa', 'hPa', 'mb']) -> xarray.DataArray
...
.. py:function:: calc_simplified_wbgt_index(temperature_data: xarray.DataArray, vapor_pressure_data: xarray.DataArray, temperature_data_units: Literal['degC', 'degF', 'degK'], vapor_pressure_data_units: Literal['Pa', 'hPa', 'mb']) -> xarray.DataArray
...
.. py:function:: calc_human_feels_temperature(temperature_data: xarray.DataArray, vapor_pressure_data: xarray.DataArray, temperature_data_units: Literal['degC', 'degF', 'degK'], vapor_pressure_data_units: Literal['Pa', 'hPa', 'mb']) -> xarray.DataArray
