:py:mod:`easyclimate.wavelet`
=============================

.. py:module:: easyclimate.wavelet
...
.. autoapisummary::
   ...
   easyclimate.wavelet.wave_signif
   easyclimate.wavelet.wavelet
   easyclimate.wavelet.timeseries_wavelet_transform
   easyclimate.wavelet.draw_global_wavelet_spectrum
   easyclimate.wavelet.draw_wavelet_transform
...
.. py:function:: timeseries_wavelet_transform(timeseries_data: xarray.DataArray, dt: float, time_dim: str = 'time', pad: float = 1, dj: float = 0.25, j1_n_div_dj: int = 7, s0=None, lag1: float = None, mother: str = 'morlet', mother_param=None, sigtest_wavelet: int = 'regular chi-square test', sigtest_global: int = 'time-average test', significance_level: float = 0.95) -> xarray.Dataset
