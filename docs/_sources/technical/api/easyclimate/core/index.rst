...
.. autoapisummary::
   ...
   easyclimate.core.transfer_deg2rad
   ...
   easyclimate.core.get_potential_temperature
   easyclimate.core.calc_static_stability
   easyclimate.core.find_dims_axis
   easyclimate.core.transfer_deg2rad
   easyclimate.core.transfer_inf2nan
   easyclimate.core.transfer_units_coeff
   easyclimate.core.transfer_data_units
   easyclimate.core.get_weighted_spatial_data
   ...
   easyclimate.core.transfer_units_coeff
   easyclimate.core.transfer_deg2rad
   easyclimate.core.transfer_dFdp2dFdz
   ...
   easyclimate.core.calc_TN_wave_activity_3D_flux
   ...
   easyclimate.core.calc_yearvar
   easyclimate.core.calc_yearmax
   easyclimate.core.calc_yearmin
   easyclimate.core.assert_compared_version
   easyclimate.core.find_dims_axis
   easyclimate.core.transfer_int2datetime
   easyclimate.core.transfer_datetime2int
   easyclimate.core.transfer_deg2rad
   easyclimate.core.transfer_inf2nan
   easyclimate.core.transfer_monmean2everymonthmean
   easyclimate.core.get_weighted_spatial_data
   easyclimate.core.get_compress_xarraydata
   easyclimate.core.transfer_dFdp2dFdz
   easyclimate.core.sort_ascending_latlon_coordinates
   easyclimate.core.transfer_units_coeff
   easyclimate.core.transfer_data_units
   easyclimate.core.generate_dataset_dispatcher
   ...
   easyclimate.core.calc_climate_monthly_std
   easyclimate.core.calc_climate_monthly_var
   ...
   easyclimate.core.save_EOF_model
   easyclimate.core.load_EOF_model
   easyclimate.core.get_MCA_model
   easyclimate.core.calc_MCA_analysis
