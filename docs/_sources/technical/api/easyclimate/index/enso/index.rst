...
.. autoapisummary::
   ...
   easyclimate.index.enso.calc_index_nino1and2
...
.. py:function:: calc_index_nino1and2(sst_monthly_anomaly: xarray.DataArray, lat_dim: str = 'lat', lon_dim: str = 'lon') -> xarray.DataArray
   ...
   Parameters
   ----------
   sst_monthly_anomaly: :py:class:`xarray.DataArray<xarray.DataArray>`
...
.. py:function:: calc_index_nino3(sst_monthly_anomaly: xarray.DataArray, lat_dim: str = 'lat', lon_dim: str = 'lon') -> xarray.DataArray
...
.. py:function:: calc_index_nino34(sst_monthly_anomaly: xarray.DataArray, lat_dim: str = 'lat', lon_dim: str = 'lon', running_mean=5) -> xarray.DataArray
...
.. py:function:: calc_index_OMI(sst_monthly_anomaly: xarray.DataArray, lat_dim: str = 'lat', lon_dim: str = 'lon', running_mean=3) -> xarray.DataArray
...
.. py:function:: calc_index_nino4(sst_monthly_anomaly: xarray.DataArray, lat_dim: str = 'lat', lon_dim: str = 'lon') -> xarray.DataArray
