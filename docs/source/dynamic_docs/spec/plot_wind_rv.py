...
:py:func:`easyclimate.spec.calc_relative_vorticity <easyclimate.core.spec.wind.calc_relative_vorticity>`
and compares the standard Fortran-backed result with
:py:func:`easyclimate.spec.calc_relative_vorticity_rs <easyclimate.core.spec.wind.calc_relative_vorticity_rs>`.
