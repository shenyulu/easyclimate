...
:py:func:`easyclimate.spec.calc_streamfunction <easyclimate.core.spec.wind.calc_streamfunction>`
and checks the Rust-backed implementation
:py:func:`easyclimate.spec.calc_streamfunction_rs <easyclimate.core.spec.wind.calc_streamfunction_rs>`.
