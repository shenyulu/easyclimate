...
def calc_seawater_thermocline_depth(
    ...
    depth_3d_array = xr.broadcast(seawater_temperature_data[depth_dim], seawater_temperature_data)[0]
...
def calc_Dx_depth(
    ...
    tmp2_deptharray = xr.broadcast(seawater_temperature_data, seawater_temperature_data[depth_dim])[1]
    data_nearest_depth = tmp2_deptharray.where(tmp1_anormaly == seawater_temperature_data).min(dim = depth_dim)
...
def calc_D14_depth(
    ...
    :py:class:`xarray.DataArray<xarray.DataArray>`. 
    """
    return calc_Dx_depth(seawater_temperature_data = seawater_temperature_data, value = value, depth_dim = depth_dim)
