...
def calc_wind_speed_rs(
    ...
    w = VectorWind_rs(
        u_data, v_data, rsphere=R, legfunc=legfunc, transform_backend=transform_backend
    )
    return w.magnitude()
...
def calc_relative_vorticity_and_horizontal_divergence_rs(
    u_data: xr.DataArray,
    v_data: xr.DataArray,
    truncation: int = None,
    R: float = 6371200.0,
...
def calc_relative_vorticity_rs(
    u_data: xr.DataArray,
    v_data: xr.DataArray,
    truncation: int = None,
    R: float = 6371200.0,
...
def calc_planetary_vorticity_rs(
    u_data: xr.DataArray,
    v_data: xr.DataArray,
    omega: float = 7.292e-05,
    R: float = 6371200.0,
...
def calc_absolute_vorticity_rs(
    u_data: xr.DataArray,
    v_data: xr.DataArray,
    truncation: int = None,
    omega: float = 7.292e-05,
...
def calc_streamfunction_and_velocity_potential_rs(
    u_data: xr.DataArray,
    v_data: xr.DataArray,
    truncation: int = None,
    R: float = 6371200.0,
...
def calc_velocity_potential_rs(
    u_data: xr.DataArray,
    v_data: xr.DataArray,
    truncation: int = None,
    R: float = 6371200.0,
...
def calc_irrotational_component_rs(
    u_data: xr.DataArray,
    v_data: xr.DataArray,
    truncation: int = None,
    R: float = 6371200.0,
...
def calc_nondivergent_component_rs(
    u_data: xr.DataArray,
    v_data: xr.DataArray,
    truncation: int = None,
    R: float = 6371200.0,
...
def calc_rossby_wave_source_rs(
    u_data: xr.DataArray,
    v_data: xr.DataArray,
    truncation: int = None,
    R: float = 6371200.0,
