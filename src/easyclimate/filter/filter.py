...
def calc_butter_bandpass(data: xr.DataArray, sampling_frequency: int, period: list, N = 3, dim = 'time') -> xr.DataArray:
...
def calc_butter_lowpass(data: xr.DataArray, sampling_frequency: int, period: int, N = 3, dim = 'time') -> xr.DataArray:
...
def calc_butter_highpass(data: xr.DataArray, sampling_frequency: int, period: int, N = 3, dim = 'time') -> xr.DataArray:
